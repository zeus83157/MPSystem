...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.PPpushButton = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        self.PPpushButton.setObjectName("PPpushButton")
        self.horizontalLayout_2.addWidget(self.PPpushButton)
        self.NButton = QtWidgets.QPushButton(self.verticalLayoutWidget_3)
        self.NButton.setObjectName("NButton")
        self.horizontalLayout_2.addWidget(self.NButton)
    ...
    def retranslateUi(self, Form):
        ...
        self.PPpushButton.setText(_translate("Form", "▊▊"))
        self.NButton.setText(_translate("Form", "►►"))
        self.label_5.setText(_translate("Form", "待播列表："))
        self.DSongpushButton.setText(_translate("Form", "刪除"))
